        ...
        <>
          <div className="user-profile-header">
            <div className="user-profile-image" id="profile-image">
              <img
                src={ParticularUser.user.avatar.url}
                alt={"profile"}
              />
            </div>
           ...
           {ParticularUser.user &&user.MyProfile ? ParticularUser.user.followers.includes(user.MyProfile._id) ?
                <i
          ...
          {ParticularUser.user.post.length > 0 ?<div className="user-profile-posts">
